...
const PaySlip = () => {
    const headData = [
        {ejraDataTitr: "تاریخ اجرا", sodurDataTitr: "تاریخ صدور", details: "نمایش فیش حقوقی"} 
      ]
    
      const [data, setData] = useState([
        {ejraData: "1403/08/14", sodurData: "1403/08/30", icon: SearchIcon },
        {ejraData: "1403/06/15", sodurData: "1403/07/30", icon: SearchIcon },
        {ejraData: "1403/02/30", sodurData: "1403/04/05", icon: SearchIcon },
        {ejraData: "1403/01/01", sodurData: "1403/02/30", icon: SearchIcon },
        {ejraData: "1402/02/01", sodurData: "1402/05/30", icon: SearchIcon },
        {ejraData: "1402/09/23", sodurData: "1402/03/12", icon: SearchIcon },
        {ejraData: "1402/01/01", sodurData: "1402/03/01", icon: SearchIcon },
        {ejraData: "1402/01/01", sodurData: "1402/03/01", icon: SearchIcon },
        {ejraData: "1402/01/01", sodurData: "1402/03/01", icon: SearchIcon },
        {ejraData: "1402/01/01", sodurData: "1402/03/01", icon: SearchIcon },
        {ejraData: "1402/01/01", sodurData: "1402/03/01", icon: SearchIcon },
